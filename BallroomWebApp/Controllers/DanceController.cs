...
namespace BallroomWebApp.Controllers
{
    public class DanceController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Speed")] Dance dance)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Speed")] Dance dance)
        {
            if (id != dance.Id)
            {
                return NotFound();
        ...
        {
            return _context.Dance.Any(e => e.Id == id);
        }
    }
}
